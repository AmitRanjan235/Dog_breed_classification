...
def get_input_args():
    ...
    parser.add_argument('--arch', default = 'vgg',type=str,help='Architecture used by CNN model for classification' )
    parser.add_argument('--dogfile', default = 'dognames.txt', type=str,help='text file with names of dogs' )
